...
namespace MSI_Keyboard_LED_Manager.Classes
{
    public class Keyboard
    {
        ...
        private const int SET_MODE = 65;
        private const int SET_REGION_COLOR = 66;
        private const int SEND_DATA = 67;
        private const int CMD_END = 236;
        ...
        private bool SendData(int type, int val1, int val2, int val3, int val4)
        {
            if (!device.IsOpen)
            {
